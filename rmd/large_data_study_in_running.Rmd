...
if (rewrangle_data) {
  ...
  write_rds(df_power_of_10, file = here("figure_data", "df_power_of_10.Rds"))
  
} else {
  
  df_power_of_10 <- read_rds(here("figure_data", "df_power_of_10.Rds"))
...
if (recompute_errors) {
  ...
  write_rds(df_errors_power_of_10, file = here("figure_data", "df_errors_power_of_10.Rds"))
